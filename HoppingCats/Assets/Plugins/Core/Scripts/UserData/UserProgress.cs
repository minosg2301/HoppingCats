...
namespace moonNest
{
    public class UserProgress : RemotableUserData<FirestoreUserData>
    {
        ...
        protected internal override void OnLoad()
        {
            ...
            {
                if(!groups.ContainsKey(groupDetail.id)) groups[groupDetail.id] = new StatProgressGroup(groupDetail);
            }
        }
        #endregion
        ...
        /// <returns></returns>
        public StatProgressGroup FindGroup(int groupId) => groups.TryGetValue(groupId, out var group) ? group : null;
        #endregion
