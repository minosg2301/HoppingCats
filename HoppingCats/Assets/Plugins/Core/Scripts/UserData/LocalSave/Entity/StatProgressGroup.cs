...
namespace moonNest
{
    ...
    public class StatProgressGroup
    {
        ...
        public int Id => id;
        public List<int> CanClaims => canClaims;
        public List<int> Claimeds => claimeds;
        public List<int> PremiumCanClaims => premiumCanClaims;
        public List<int> PremiumClaimeds => premiumClaimeds;
