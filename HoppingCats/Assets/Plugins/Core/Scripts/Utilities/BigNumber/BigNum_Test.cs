...
namespace BigNumbers
{
    public partial class BigNumber
    {
        public static void DoTest()
        {
            ...
            A = "12345";
            Console.WriteLine("assigned value was: " + A.FullString() + "(" + A.ToString() + ")");
            ...
            C = 10000;
            Console.WriteLine("assigned value was: " + A.FullString() + "(" + A.ToString()+")");
            Console.WriteLine("10000 = " + A.FullString() + " = " + B.FullString() + " = " + C.FullString());
            
            A = 1; B = 2; C = 0;
            C = A + B;
            Console.WriteLine("the result of " + A.FullString() + "+" + B.FullString() + "=" + C.FullString());
            ...
            A = 4; B = 0.5;
            C = A.Pow(B);
            Console.WriteLine("the result of " + A.FullString() + " pow " + B.FullString() + "=" + C.FullString());
            ...
            A = "1e3"; // "10E2"; //   "1E3 = 1000";
            C = A.Log10();
            Console.WriteLine("the result of " + A.FullString() + " Log10 =" + C.FullString());
           
            A = "10E3"; B = "1E4"; C=10000 ;

            A = BigNumber.BN_E;
            C = A.Log();
            Console.WriteLine("the result of " + A.ToString() + " Log =" + C.FullString());

            A = 3.0;
            C = A.Rez();
            Console.WriteLine("the result of " + A.ToString() + " Rez =" + C.FullString());

            int NumPlaces = 4;
            A = 1.53456;
            C = A.Round(NumPlaces);
            Console.WriteLine("the result of " + A.ToString() + " Round(" + NumPlaces + ") =" + C.FullString());
            ...
            A = 2.0;
            C = A.Sqrt(NumPlaces);
            Console.WriteLine("the result of " + A.ToString() + " Sqrt(" + NumPlaces + ") =" + C.FullString());
            ...
            Console.WriteLine("the result of 1000!=" + A.FullString());
            ...
            Console.WriteLine(PI.FullString());
