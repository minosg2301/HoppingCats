...
namespace moonNest
{
    public class TabContainer
    {
        ...
        private void DrawVerticalHeader()
        {
            ...
            items.ForEach(ele =>
            {
                ...
                if(ele.overrideColor) GUI.backgroundColor = ele.backgroundColor;
                if(Draw.ToggleButton(ele == SelectedItem, ele.label.ToUpper(), TabWidth, TabHeight)) SelectedItem = ele;
                if(ele.overrideColor) GUI.backgroundColor = color;
            });
            if(OnButtonAdd != null)
            {
                Color color = GUI.backgroundColor;
    ...
    public class TabItem
    {
        ...
        public Color Color { set { backgroundColor = value; overrideColor = true; } }
    }
