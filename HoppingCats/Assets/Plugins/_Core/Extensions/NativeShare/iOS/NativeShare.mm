...
extern "C" void _NativeShare_ShareViaMessenger ( const char* link )
{
    NSURL *openURL = [NSURL URLWithString:[NSString stringWithFormat:@"fb-messenger://share/?link=%s", link]];
    [[UIApplication sharedApplication] openURL:openURL];
}

extern "C" bool _NativeShare_HasMessenger ()
{
