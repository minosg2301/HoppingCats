...
public class NativeShare
{
    ...
    [System.Runtime.InteropServices.DllImport( "__Internal" )]
	private static extern void _NativeShare_ShareViaMessenger( string link );

    [System.Runtime.InteropServices.DllImport( "__Internal" )]
	private static extern bool _NativeShare_HasMessenger();
#endif
    ...
    public static bool HasMessenger()
    {
#if UNITY_EDITOR
        return false;
#elif UNITY_ANDROID
        return TargetExists("com.facebook.orca");
#elif UNITY_IOS
        return _NativeShare_HasMessenger();
#else
        return false;
#endif
    }

    public NativeShare SendViaMessenger()
    {
        viaMessenger = true;
#if UNITY_ANDROID
        AddTarget("com.facebook.orca");
#endif
        return this;
    }
    ...
    public void Share()
    {
        ...
        if (files.Count == 0)
        {
            if (viaMessenger)
            {
                _NativeShare_ShareViaMessenger(GetURLWithScheme());
            }
            else
            {
