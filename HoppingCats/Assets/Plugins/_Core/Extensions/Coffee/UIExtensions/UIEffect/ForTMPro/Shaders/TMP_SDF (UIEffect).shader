...
SubShader {
	...
	Pass {
		...
		#include "Assets/Plugins/_Core/Extensions/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Assets/Plugins/_Core/Extensions/TextMesh Pro/Shaders/TMPro.cginc"
