...
namespace Google.Impl
{
    ...
    public GoogleSignInStatusCode Status {
      get {
        ...
        public bool Pending => true;// throw new NotImplementedException();

        public GoogleSignInStatusCode Status => GoogleSignInStatusCode.Canceled;

        public GoogleSignInUser Result => null;//throw new NotImplementedException();
#endif
    }
}
