...
namespace Com.TheFallenGames.OSA.Core
{
	...
	public class LayoutInfo
	{
		...
		public readonly Vector2 botLeftPosForAllItems = new Vector2(0f, 0f); // bot-left
		...
		internal void CacheScrollViewInfo(BaseParams parameters)
		{
			...
			{
				startEdge = parameters.Inverse ? RectTransform.Edge.Bottom : RectTransform.Edge.Top;
				endEdge = parameters.Inverse ? RectTransform.Edge.Top : RectTransform.Edge.Bottom;
