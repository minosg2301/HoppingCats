...
namespace I2.Loc
{
    [CustomEditor(typeof(LocalizeParams))]
	public class LocalizeParamsInspector : Editor
	{
        ...
        private void addElementCallback( ReorderableList list )
        {
            ...
            var objParams = (target as LocalizeParams);
            objParams._Params.Add(new LocalizeParams.ParamValue());
