...
namespace Doozy.Editor.UI
{
    ...
    public class UIPopupEditor : BaseEditor
    {
        ...
        private SerializedProperty
            ...
            m_updateShowProgressorOnHide,//baontp
            m_useCustomStartAnchoredPosition,//baontp
            m_customStartAnchoredPosition;//baontp
        ...
        private AnimBool
            ...
            m_showExpanded,
            m_soundDataExpanded,
            m_unityEventsExpanded,//baontp
            m_useCustomStartPositionExpanded;//baontp
        ...
        protected override void LoadSerializedProperty()
        {
            ...
            m_useCustomStartAnchoredPosition = GetProperty(PropertyName.UseCustomStartAnchoredPosition);//baontp
            m_customStartAnchoredPosition = GetProperty(PropertyName.CustomStartAnchoredPosition);//baontp
        }
        ...
        protected override void InitAnimBool()
        {
            ...
            m_useCustomStartPositionExpanded = GetAnimBool(m_useCustomStartAnchoredPosition.propertyPath, m_useCustomStartAnchoredPosition.boolValue);//baontp
        }
