...
namespace Doozy.Engine.Utils
{
    ...
    public class DoozyPath : ScriptableObject
    {
        ...
        // baontp
        public static string ENGINE_RESOURCES_DATA_PATH = "Assets/_Game/Resources/Doozy";
        public static string ENGINE_SETTINGS_RESOURCES_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, SETTINGS);
        // baontp - end
...
//            DoozyUtils.ClearProgressBar();
            ...
            if(!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_PATH))
                UnityEditor.AssetDatabase.CreateFolder("Assets/_Game/Resources", "Doozy"); // -- Assets/_Game/Resources/Doozy/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_SETTINGS_RESOURCES_PATH, 0.11f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_SETTINGS_RESOURCES_PATH))
                UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, SETTINGS); // -- Assets/_Game/Resources/Doozy/
            ...
            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_SETTINGS_RESOURCES_PATH, 0.25f);
