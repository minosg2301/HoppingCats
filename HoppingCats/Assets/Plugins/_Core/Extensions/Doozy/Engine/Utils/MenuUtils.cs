...
namespace Doozy.Engine.Utils
{
    public static class MenuUtils
    {
        ...
        //UIPopup Node
        public const string UIPopupNode_CreateNodeMenu_Name = "UIPopupNode";
        public const int UIPopupNode_CreateNodeMenu_Order = DefaultNodeOrder;
        public const string UIPopupNode_Manual = "http://doozyui.com/nodes/#UIPopupNode";
        public const string UIPopupNode_YouTube = "https://www.youtube.com/watch?v=BTZRxxSTOcA";
        ...
        //ProgressTargetTransform
        public const string ProgressTargetTransform_GameObject_Name = "Progress Target Transform";
        public const string ProgressTargetTransform_AddComponentMenu_MenuName = Progress_Targets_AddComponentMenu_Path + ProgressTargetTransform_GameObject_Name;
        public const int ProgressTargetTransform_AddComponentMenu_Order = PROGRESS_MENU_ORDER;
        public const string ProgressTargetTransform_MenuItem_ItemName = Progress_Targets_MenuItem_Path + ProgressTargetTransform_GameObject_Name;
        public const int ProgressTargetTransform_MenuItem_Priority = PROGRESS_MENU_ORDER;
        public const string ProgressTargetTransform_Manual = "http://doozyui.com/progress-target-Transform/";
        public const string ProgressTargetTransform_YouTube = "https://www.youtube.com/watch?v=XUH85WaPg_0";

        //ProgressTargetLayout
        public const string ProgressTargetLayout_GameObject_Name = "Progress Target Layout";
        public const string ProgressTargetLayout_AddComponentMenu_MenuName = Progress_Targets_AddComponentMenu_Path + ProgressTargetLayout_GameObject_Name;
        public const int ProgressTargetLayout_AddComponentMenu_Order = PROGRESS_MENU_ORDER;
        public const string ProgressTargetLayout_MenuItem_ItemName = Progress_Targets_MenuItem_Path + ProgressTargetLayout_GameObject_Name;
        public const int ProgressTargetLayout_MenuItem_Priority = PROGRESS_MENU_ORDER;
        public const string ProgressTargetLayout_Manual = "http://doozyui.com/progress-target-Transform/";
        public const string ProgressTargetLayout_YouTube = "https://www.youtube.com/watch?v=XUH85WaPg_0";
        ...
        public const string NodyWindow_OpenShortcut = " &s"; // Keyboard Shortcut: None
