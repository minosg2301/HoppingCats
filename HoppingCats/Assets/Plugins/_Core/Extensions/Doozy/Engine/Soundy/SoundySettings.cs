...
namespace Doozy.Engine.Soundy
{
    ...
    public class SoundySettings : ScriptableObject
    {
        ...
        private static string ResourcesPath { get { return DoozyPath.ENGINE_SETTINGS_RESOURCES_PATH; } }

#if DOOZY_EXTERNAL_DATA
        public static void SetInstance(SoundySettings instance)
        {
            s_instance = instance;
        }
#endif
