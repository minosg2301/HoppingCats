...
namespace Doozy.Engine.UI
{
    ...
    public class UIPopupManager : MonoBehaviour
    {
        ...
        /// <summary> Action invoked whenever an PopupQueue is updated </summary>
        public static Action onQueueUpdated = delegate { };
        ...
        public static UIPopup GetPopup(string popupName)
        {
            ...
            GameObject clone = Instantiate(prefab, canvas.container ? canvas.container : canvas.transform);
        ...
        public static void ShowNextInQueue()
        {
            while (true)
            {
                ...
                UIPopup showPopup = PopupQueue[0].Show();
                CurrentVisibleQueuePopup = showPopup;
                VisiblePopups.Add(showPopup);
                showPopup.HideBehavior.OnFinished.Event.AddListener(() => VisiblePopups.Remove(showPopup));
                // baontp - end
                break;
            }
        }
        ...
        public static void ShowPopup(UIPopup popup, bool addToPopupQueue, bool instantAction)
        {
            ...
            popup.HideBehavior.OnFinished.Event.AddListener(() => VisiblePopups.Remove(popup));
            // baontp - end
