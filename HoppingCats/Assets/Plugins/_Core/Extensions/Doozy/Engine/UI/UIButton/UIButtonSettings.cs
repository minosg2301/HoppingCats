...
namespace Doozy.Engine.UI.Settings
{
    ...
    public class UIButtonSettings : ScriptableObject
    {
        ...
        public void ResetComponent(UIButton button)
        {
            ...
            button.OnPointerDown = new UIButtonBehavior(UIButtonBehaviorType.OnPointerDown, true);
            ...
            button.OnPointerUp = new UIButtonBehavior(UIButtonBehaviorType.OnPointerUp, true);
            ...
            // baontp - override button behaviour
            button.OnPointerDown.LoadSelectedPresetAtRuntime = true;
            button.OnPointerDown.ButtonAnimationType = ButtonAnimationType.State;
            button.OnPointerDown.PresetCategory = "Basic";
            button.OnPointerDown.PresetName = "ScaleIn";
            button.OnPointerUp.LoadSelectedPresetAtRuntime = true;
            button.OnPointerUp.ButtonAnimationType = ButtonAnimationType.State;
            button.OnPointerUp.PresetCategory = "Basic";
            button.OnPointerUp.PresetName = "ScaleInReset";
            button.OnClick.OnTrigger.SoundData.DatabaseName = "Sfx";
            button.OnClick.OnTrigger.SoundData.SoundName = "Click";
            button.LoadPresets();
            // baontp - end
        }
