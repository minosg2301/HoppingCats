...
namespace moonNest
{
    ...
    public class UserData : RemotableUserData<FirestoreUserData>
    {
        ...
        public event Action<bool> onLogin = delegate { };
        public event Action<StatData> onStatUpdated = delegate { };
        public event Action<SafeStatData> onSafeStatUpdated = delegate { };
        public event Action<AttributeData> onAttributeUpdated = delegate { };
        #endregion
