...
namespace moonNest
{
    ...
    public class Item : DataObject<ItemDetail>
    {
        ...
        [SerializeField] long amount; // removed in future
        [SerializeField] SafeLong safeAmount;
        ...
        internal void Init(ItemDetail detail)
        {
            ...
            safeAmount = new SafeLong(amount);
        ...
        internal void InitSafeAmountIfNULL()
        {
            safeAmount ??= new SafeLong(amount);
        }
        ...
        public void AddAmount(int value, UnitApplyType applyType = UnitApplyType.Single)
        {
            ...
            long lastAmount = safeAmount.Value;
            long newAmount = MathExt.Clamp(lastAmount + value, 0, max);
            int diff = (int)(newAmount - lastAmount);
            
            safeAmount.Value = newAmount;
