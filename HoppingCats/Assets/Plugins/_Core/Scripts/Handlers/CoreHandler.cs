...
namespace moonNest
{
    ...
    public class CoreHandler : SingletonMono<CoreHandler>
    {
        ...
        private void OnCurrencyAdded(Currency currency, UnitApplyType applyType)
        {
            DoAction(ActionDefinition.GainCurrencyAction(currency.Id), (int)Math.Abs(currency.Modifier));
        }
        #endregion
        ...
        public static void DoAction(ActionData action, long value = 1)
        {
