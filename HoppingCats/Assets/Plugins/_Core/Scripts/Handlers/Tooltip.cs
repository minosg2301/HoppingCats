...
namespace moonNest
{
    ...
    {
        public delegate void RequestChestTooltip(Transform target, ChestDetail chestDetail);
        ...
        public static void ShowChestTooltip(Transform target, ChestDetail chestDetail)
        {
            if(!chestDetail)
                throw new NullReferenceException("ShowChestTooltip null chest detail");

            requestChestTooltip?.Invoke(target, chestDetail);
        }
    }
}