...
namespace moonNest
{
    public enum HapticType { Selection, Success, Warning, Failure, LightImpact, MediumImpact, HeavyImpact, None }
    ...
    public static class Vibration
    {
        ...
        public static void DoVibrate()
        {
            ...
            {
                iOSTriggerHaptics(HapticType.MediumImpact);
            }
        }
        ...
        public static void DoHaptic(HapticType type, bool defaultToRegularVibrate = false)
        {
        ...
        /// </summary>
        /// <param name="type">Type.</param>
        public static void iOSTriggerHaptics(HapticType type)
        {
            if (!iOS()) { return; }
