...
namespace BigNumbers
{
    public partial class BigNumber
    {
        ...
        static public float Percent(BigNumber aa, BigNumber bb)
        {
            sbyte sign;
            ...
            int de = bb.exponent - aa.exponent;
            ...
            if (aa.exponent > 4)
            {
                numCut = aa.exponent - 4;
            }
            BigNumber ta = new BigNumber(aa);
            ta.exponent -= (numCut - 2);
            BigNumber tb = new BigNumber(bb);
            tb.exponent -= numCut;

            int ia = int.Parse(ta.IntString());
            int ib = int.Parse(tb.IntString());
            return ia * 1.0f / ib;
        }
