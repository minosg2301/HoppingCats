...
namespace moonNest
{
    public class CollectingManager : SingletonMono<CollectingManager>, IObservable
    {
        ...
        void OnCurrencyAdded(Currency currency, UnitApplyType applyType)
        {
            ...
            AddRequest(new CollectCurrency(currency, (long) currency.Modifier));
        }
    ...
    public class CollectRequest
    {
        ...
        public CollectRequest(CollectType type, long amount, Sprite icon)
        {
            this.type = type;
            this.amount = amount;
            this.icon = icon;
        ...
        public CollectRequest(CollectType type, long amount, Sprite icon, GameObject prefab)
        {
            this.type = type;
            this.amount = amount;
            this.icon = icon;
    ...
    public class CollectCurrency : CollectRequest
    {
        ...
        public CollectCurrency(Currency currency, long amount)
