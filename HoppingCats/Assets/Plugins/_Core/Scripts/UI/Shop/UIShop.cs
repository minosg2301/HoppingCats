...
namespace moonNest
{
    public class UIShop : MonoBehaviour, IObserver
    {
        ...
        public Action<UIShopItem> onShopItemSelected = delegate { };
        public Action<UIShopItem> onBuyShopItem = delegate { };
        public Action<ShopItem, Item> onBuyItem = delegate { };
        public Action<ShopItem, Currency> onBuyCurrency = delegate { };
        public Action<ShopItem, ChestDetail> onBuyChest = delegate { };
